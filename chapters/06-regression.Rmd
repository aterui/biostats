...
Minimizing the squared magnitude of $\overrightarrow{\varepsilon}$ (solve the partial derivative of $||\overrightarrow{\varepsilon}||^2$ about $\Theta$) leads to the solution (for detailed derivation, refer to [Wikipedia](https://en.wikipedia.org/wiki/Least_squares)):
