...
Using matrix notation, we can express the error vector \(\overrightarrow{\varepsilon}\) as:

\[
\overrightarrow{\varepsilon} = Y - X\Theta
\]
...
Minimizing the squared magnitude of \(\overrightarrow{\varepsilon}\) (solve the partial derivative of \(||\overrightarrow{\varepsilon}||^2\) about \(\Theta\)) leads to the solution (for detailed derivation, refer to \href{https://en.wikipedia.org/wiki/Least_squares}{Wikipedia}):
