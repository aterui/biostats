...
Download the data \href{C:/Users/Akira/OneDrive\%20-\%20UNCG/Documents/github/biostats/data_raw/data_plant_height.csv}{here} containing height measurements of thousand individuals, and place this file under \texttt{data\_raw/} in your project directory. You can load this \texttt{csv} file in R as follows:
...
Actually, this is the default formula in \texttt{var()} in R, a function used to estimate \emph{unbiased} variance (and \emph{unbiased} SD \texttt{sd()}). Comparison reveals how this works:
