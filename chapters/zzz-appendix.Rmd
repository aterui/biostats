...
# Basic Terminology {.unnumbered}

Statistics uses specialized terminology, and its interpretation is often not intuitive. Below, I list key terms that may require clarification, along with helpful links for further explanation.

- [Parametric vs. Non-parametric](https://statisticsbyjim.com/hypothesis-testing/nonparametric-parametric-tests/)
- [Confidence interval](https://statisticsbyjim.com/hypothesis-testing/confidence-interval/)
- [Correlation](https://statisticsbyjim.com/glossary/correlation-coefficient/)
- [Covariance](https://statisticsbyjim.com/basics/covariance/)
- [Covariance vs. Correlation](https://statisticsbyjim.com/basics/covariance-vs-correlation/)
- [Covariance Matrix](https://statisticsbyjim.com/glossary/covariance-matrix/)
