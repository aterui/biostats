...
The results can be visualized with the `lavaanPlot()` function from `lavaanPlot` package.
...
However, such models are challenging to estimate using standard methods because the likelihood function becomes highly complex. In these cases, piecewise SEM ([Lefcheck 2015](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.12512)) or Bayesian methods would provide a more flexible framework (examples: [Takagi et al. 2014](onlinelibrary.wiley.com/doi/abs/10.1111/1365-2656.12415); [Terui et al 2018](doi.org/10.1007%2Fs10021-017-0183-3)). While there are currently few packages that allow fully automated implementation, coding models directly in BUGS or Stan makes it possible to fit these more complex SEMs (with a steep learning curve).
